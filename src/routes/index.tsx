...
const STEPS = [
  ...
  ["03", "Stay in control", "Strap keeps sales, stock, expenses and orders connected as the day changes."],
        ...
        <section className="kudi-hero relative isolate flex min-h-[100svh] overflow-hidden bg-foreground text-background">
          ...
          <div className="relative mx-auto flex min-h-[100svh] w-full max-w-7xl items-end px-4 pb-16 pt-24 sm:px-6 sm:pb-20 lg:items-center lg:pb-0">
            <div className="max-w-3xl animate-[fade-in-up_.75s_ease-out_both]">
              ...
              <h1 className="mt-6 max-w-4xl font-display text-5xl font-bold tracking-[-.05em] sm:text-[5.4rem] sm:leading-[.9]">Your shop moves fast. <span className="text-accent">Strap keeps up.</span></h1>
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Strap — Point of Sale, Inventory & Online Store for Nigerian Businesses" },
      { name: "description", content: "Strap is a modern POS and retail management platform for Nigerian businesses. Sell faster, manage inventory, track expenses, publish an online catalogue and receive customer orders in one workspace." },
      { name: "keywords", content: "Strap POS Nigeria, point of sale Nigeria, inventory management Nigeria, retail software Nigeria, stock management, online store Nigeria, catalogue management, barcode scanner POS, small business POS" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Strap — Point of Sale, Inventory & Online Store" },
      ...
      { name: "twitter:title", content: "Strap — Point of Sale, Inventory & Online Store" },
