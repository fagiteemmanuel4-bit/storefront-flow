...
export const Route = createFileRoute("/customer-account")({
  validateSearch: (search: Record<string, unknown>) => ({ store: typeof search.store === "string" ? search.store : "" }),
  head: () => ({ meta: [{ title: "My orders — Kudi" }, { name: "description", content: "Manage your temporary Kudi customer account and track your orders." }] }),
...
function CustomerAccountPage() {
  ...
  async function submitAccount() {
    if (!store) { toast.error("Open this page from a Kudi store."); return; }
    setSubmitting(true);
    try {
