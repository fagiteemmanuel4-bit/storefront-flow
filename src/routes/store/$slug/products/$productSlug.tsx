...
function PublicProductPage() {
  ...
  return <main className="min-h-screen bg-background">
    ...
    <footer className="mt-10 border-t border-border px-5 py-8"><div className="mx-auto flex max-w-6xl justify-between gap-4 text-xs text-muted-foreground"><Link to="/store/$slug" params={{ slug }} className="hover:underline">{product.store_name}</Link><span>Powered by Kudi</span></div></footer>
  </main>;
}
