...
function OrderTrackingPage() {
  ...
  return <main className="min-h-screen bg-background px-5 py-8 sm:py-12"><div className="mx-auto max-w-2xl"><div className="mb-8"><p className="text-label-caps text-muted-foreground">Strap order tracking</p><h1 className="text-display-lg mt-2">Order #{order.order_number}</h1><p className="mt-2 text-sm text-muted-foreground">Keep this page or save this link to check your order anytime.</p></div>
    ...
    <p className="mt-8 text-center text-xs text-muted-foreground">Powered by Strap</p></div></main>;
}
