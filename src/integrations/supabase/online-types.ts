...
export type OnlineCatalogRow = { store_id: string; slug: string; display_name: string; logo_url: string; display_email: string; display_phone: string; store_description: string; currency: string; product_id: string; name: string; sku: string; category: string; price: number; image_url: string; featured: boolean; description: string };
...
export type OnlineDatabase = {
  public: {
    ...
    Views: { online_catalog: { Row: OnlineCatalogRow; Insert: never; Update: never; Relationships: [] } };
