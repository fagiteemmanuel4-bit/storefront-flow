...
import { BarChart3, CloudUpload, FileBarChart, Package, Receipt, ScanLine, Store, Wifi, WifiOff } from "lucide-react";
...
export function AppShell({ title, children }: { title: string; children: ReactNode }) {
  ...
  return <div className="min-h-screen bg-background pb-24 lg:pb-0">
    ...
    <UpdatesSheet />
    <ProductTour />
    <AppMenuSheet open={menuOpen} onOpenChange={setMenuOpen} store={store} branchName={branch?.name ?? null} role={role} onSignOut={() => { setMenuOpen(false); void handleSignOut(); }} />
  </div>;
}
