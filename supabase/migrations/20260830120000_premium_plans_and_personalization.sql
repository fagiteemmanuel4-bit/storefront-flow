...
-- No destructive changes: all additions are nullable/defaulted.
...
-- Public storefronts are a paid capability. Existing storefront records remain intact,
-- but public publishing requires an active Business or Pro subscription.
